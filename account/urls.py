...
from account.views import LoginView, LogoutView, ProfileCreateView, ProfileDeleteView, ProfileListView, \
    ProfileUpdateView, ProfileUpdatePasswordView, ProfileDetailView
...
urlpatterns = [
    ...
    url(r'^update/password/(?P<pk>[0-9]+)/$', ProfileUpdatePasswordView.as_view(), name='update_password_user'),
